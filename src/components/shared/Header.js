  ...
  return (
    <>
      ...
      <div className="desktop-nav-links-container">
          ...
          <a className="desktop-nav-link" href="https://influencer.tylerhuyser.com/#about-section">ABOUT</a>           
          ...
          <a className="desktop-nav-link" href="https://influencer.tylerhuyser.com/#contact-form" id="contact-form-link">CONTACT</a>
      ...
      <div className={menuVisibility ? "mobile-menu mobile-menu-visible" : "mobile-menu mobile-menu-hidden"}>
        ...
        <a className="mobile-nav-link" href="https://influencer.tylerhuyser.com/#about-section"  onClick={() => setMenuVisibility(false)}>ABOUT</a>
        ...
        <a className="mobile-nav-link" href="https://influencer.tylerhuyser.com/#contact-form">CONTACT</a>
